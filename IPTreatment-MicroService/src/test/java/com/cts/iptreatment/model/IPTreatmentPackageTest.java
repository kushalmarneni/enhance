...
class IPTreatmentPackageTest {
	@Test
	void testNoArgs() {
		assertThat(new IPTreatmentPackage()).isNotNull();
	}
	@Test
	void testAllArgs() {
		PackageDetail packageDetail = new PackageDetail(1, "package 1", Arrays.asList("",""),12000,3);
		assertThat(assertThat(new IPTreatmentPackage(1, AilmentCategory.ORTHOPAIDICS, packageDetail)).isNotNull());
	}
	@Test
    void testTreatPlanBeanGettersAndSetters() {
        ...
        beanTester.testBean(IPTreatmentPackage.class);
    }
}
